...
export const useDojo = () => {
    ...
    const { create, list, get, account, select } = useBurner({ masterAccount: masterAccount, accountClassHash: import.meta.env.VITE_PUBLIC_ACCOUNT_CLASS_HASH!, provider: provider });
